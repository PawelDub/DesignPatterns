...
public class ClientApplication {
    ...
    public static void main(String[] args) {
        List<Czlowiek> czlowieki = new ArrayList<Czlowiek>();
        ...
        Collections.sort(czlowieki, new ComparatorName());
        ...
        czlowieki
                ...
                .sorted(Comparator.comparing(Czlowiek::getName)
                        .thenComparing(Comparator.comparing(Czlowiek::getSurname)))
                .forEach((Czlowiek e) -> System.out.println(e));
    }

    public static Comparator<Czlowiek> comparatorByName() {
        return (name1, name2) -> name1
                .getName().compareTo(name2.getName());
    }

    public static Comparator<Czlowiek> comapratorBySurname() {
        return (surname1, surname2) -> surname1.getSurname()
                .compareTo(surname2.getSurname());
    }
